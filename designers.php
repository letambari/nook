            ...
            <div class="container">
                <div class="tzHeaderContainer">
                    <h3 class="pull-left tz_logo">
                        <a title="Home" href="#">
                            <img src="photos/logotry.png" alt="nook-fashion">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="tz_breadcrumb_single_cat_title">
                        <h4> Designers Registration Portal </h4>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="tz_gmaps">
                            <center>
           <h3>Register as a Model? <a href="index.php" class="btn btn-warning">Clcik Here</a></h3> 
           </center>
        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        ...
                        <img src="photos/designers.jpeg" width="800" height="559" allowfullscreen>
                    </div>
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        ...
                        <input class="wpcf7-form-control wpcf7-text" type="text" placeholder="Brand Name *" aria-invalid="false" aria-="true" size="40" name="brandname" required>
                                    </span>
...
$(document).ready(function(){
    $("form").submit(function(event){
        ...
        $.post("designcode.php", formValues, function(data){
