...
<head>
	...
	<link rel="shortcut icon" href="https://phfashionweek.com/assets/images/logowhite.svg" type="image/x-icon" />
	<link rel="apple-touch-icon" href="https://phfashionweek.com/assets/images/logowhite.svg" />
	<link rel="apple-touch-icon" sizes="72x72" href="https://phfashionweek.com/assets/images/logowhite.svg" />
	<link rel="apple-touch-icon" sizes="114x114" href="https://phfashionweek.com/assets/images/logowhite.svg" />
...
<header class="header" id="header">
	...
	<section class="page__img" style="background-image: url('branding/DSC_0758.jpg')">
		<div class="container">
			<div class="row">
	...
	<section class="section contacts">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-12">
				<h2>MASTER</h2>
                <!-- <a href="single-post.html" class="btn btn-default btn__grey animation">EXHIBITION</a>
                <a href="single-post.html" class="btn btn-default btn__grey animation">MASTER CLASS</a> -->
					<form class="vertical-form" method="POST">
						...
						<div class="form-group">
	    					<label for="c-email">Business <span class="req">*</span></label>
	    					<input type="name" class="form-control" id="business" name="business">
						</div>
						
						<div class="form-group">
	    					<label for="c-email">Designation <span class="req">*</span></label>
	    					<input type="designation" class="form-control" id="designation" name="designation">
						</div>
							<div class="form-group">
	    					<label for="c-email">Days to Attend <span class="req">*</span></label>
						...
						<input type="submit" class="btn btn__red animation" name="update_cart" value="Submit" />
					</form>

                    <div id="result"></div>

                    <div class="contact-info">
						<h4 class="contact-info__item"><i class="mdi mdi-cellphone-android"></i>Phone: 0803 875 3903</h4>
						<h4><i class="mdi mdi-email"></i>info@phfdweek.com</h4>
					</div>
				</div>
...
$(document).ready(function(){
    $("form").submit(function(event){
        ...
        $.post("bookmaster.php", formValues, function(data){
